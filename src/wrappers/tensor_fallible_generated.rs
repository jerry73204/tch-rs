...
impl Tensor {
    ...
    pub fn f_internal_cudnn_ctc_loss(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2usize];
        ...
        Ok((
            Tensor {
                c_tensor: c_tensors[0usize],
            },
            Tensor {
                c_tensor: c_tensors[1usize],
            },
        ))
    }
    ...
    pub fn f_internal_cudnn_rnn<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 5usize];
        ...
        Ok((
            ...
            Tensor {
                c_tensor: c_tensors[2usize],
            },
            Tensor {
                c_tensor: c_tensors[3usize],
            },
            Tensor {
                c_tensor: c_tensors[4usize],
            },
        ))
    }
    ...
    pub fn f_conv_tbc_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 3usize];
    ...
    pub fn f_cudnn_batch_norm<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 4usize];
    ...
    pub fn f_internal_fft_with_size1(
        &self,
        signal_ndim: i64,
        complex_input: bool,
        complex_output: bool,
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!(atg__fft_with_size1(
            c_tensors.as_mut_ptr(),
            self.c_tensor,
            signal_ndim,
            if complex_input { 1 } else { 0 },
